...
$.fn.validatebox.defaults={required:false,validType:null,validParams:null,delay:200,missingMessage:"不能为空.",invalidMessage:null,tipPosition:"right",deltaX:0,novalidate:false,events:{focus:_b,blur:_10,mouseenter:_14,mouseleave:_17,click:function(e){
var t=$(e.data.target);
if(!t.is(":focus")){
t.trigger("focus");
}
...
},message:"请输入合法的email地址."},url:{validator:function(_3b){
...
},message:"请输入合法的URL."},length:{validator:function(_3c,_3d){
var len=$.trim(_3c).length;
return len>=_3d[0]&&len<=_3d[1];
},message:"请输入长度为 {0} 到 {1} 的值."},remote:{validator:function(_3e,_3f){
var _40={};
_40[_3f[1]]=_3e;
