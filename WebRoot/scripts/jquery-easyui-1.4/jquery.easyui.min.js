...
},beforePageText:"第",afterPageText:"页 共{pages}页",displayMsg:"当前{from}到{to},共{total}记录",nav:{first:{iconCls:"pagination-first",handler:function(){
