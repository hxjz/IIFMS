...
<body>
	...
	<table border="0">
		...
		<tr>
			<td class="tr"><span class="t_span01">案发时间：</span></td>
			<td width="160">
				<input class="easyui-datetimebox w140" data-options="" name="caseTimeStart" id="caseTimeStart"
					   type="text" value="${finances.cases.caseTimeStart}" readonly="readonly"/><span class="t_span01">起</span>
			</td>
			<td class="tr">&nbsp;</td>
			<td width="160">
				<input class="easyui-datetimebox w140" data-options="" name="caseTimeEnd" id="caseTimeEnd"
			...
			<td class="tr" width="100"><span class="t_span01">当前时间：</span></td>
			<td><input class="easyui-datetimebox w140" data-options="" name="currentTime" id="currentTime"
		...
		<tr>
			...
			<td class="tr" width="100"><span class="t_span01">保管单位：</span></td>
			<td>
				<input class="easyui-validatebox w140" data-options="" name="storeOffice" id="storeOffice"
		...
		<tr>
			<td class="tr" width="100"><span class="t_span01">登记时间：</span></td>
			<td>
				<input class="easyui-datetimebox w140" data-options="" name="entryTime" id="entryTime"
					   type="text" value="${finances.entryTime}" readonly="readonly"/>
			</td>
			<td class="tr" width="100"><span class="t_span01">首次入库时间：</span></td>
			<td>
				<input class="easyui-datetimebox w140" data-options="" name="instockTime" id="instockTime"
					   type="text" value="${finances.instockTime}" readonly="readonly"/>
			</td>
			<td class="tr" width="100"><span class="t_span01">最终出库时间：</span></td>
			<td>
				<input class="easyui-datetimebox w140" data-options="" name="outstockTime" id="outstockTime"
        ...
        <tr>
			<td class="tr" width="100"><span class="t_span01">登记人：</span></td>
			<td>
				<input class="easyui-validatebox t_text w140" data-options=""
					   name="entryMan" type="text" value="${finances.entryMan}" readonly="readonly"/>
			</td>
			<td class="tr" width="100"><span class="t_span01">首次入库人：</span></td>
			<td>
				<input class="easyui-validatebox t_text w140" data-options=""
					   name="instockMan" type="text" value="${finances.instockMan}" readonly="readonly"/>
			</td>
			<td class="tr" width="100"><span class="t_span01">最终出库人：</span></td>
			<td>
				<input class="easyui-validatebox t_text w140" data-options=""
