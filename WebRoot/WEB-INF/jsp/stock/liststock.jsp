					...
					<table id="dg1" style="width:100%; height:350px" data-options="singleSelect:true,collapsible:false,
						...
						<thead>
							<tr>
								...
								<th data-options="field:'financeNum',width:60" align="center">财物编号</th>
								<th data-options="field:'financeName',width:130" align="center">财物名称</th>
								<th data-options="field:'financeType',width:70,formatter:formatFinanceType" align=" center">财物类型</th>
								<th data-options="field:'financeState',width:60,formatter:formatFinanceState" align="center">财物状态</th>
								<th data-options="field:'row.cases.caseNum',width:80,formatter:formatCaseNum" align="center">案件编号</th>
								<th data-options="field:'row.cases.caseName',width:80,formatter:formatCaseName" align="center">案件名称</th>
								<th data-options="field:'row.cases.caseType',width:80,formatter:formateCaseType" align="center">案件类型</th>
								...
								<th data-options="field:'storeLocation',width:180" align="center">存放位置</th>
